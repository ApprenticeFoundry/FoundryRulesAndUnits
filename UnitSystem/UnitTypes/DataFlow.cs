...
namespace FoundryRulesAndUnits.Units
{
	...
	public class DataFlow : MeasuredValue
	{
		...
		[Obsolete("Use factory methods like FromBytesPerSecond() for new code. This method is maintained for backward compatibility.")]
		public static Func<UnitCategory> Category = () => new UnitCategory("DataFlow");

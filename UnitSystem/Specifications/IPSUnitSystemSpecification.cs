...
namespace FoundryRulesAndUnits.Units.Specifications
{
    ...
    public class IPSUnitSystemSpecification : IUnitSystemSpecification
    {
        ...
        public IReadOnlyList<UnitDefinition> UnitDefinitions { get; } = new List<UnitDefinition>
        {
            ...
            UnitDefinition.LinearUnit("mi", "miles", UnitFamilyName.Length, 63360.0),           // 1 mi = 63360 in
            ...
            UnitDefinition.LinearUnit("nmi", "nautical miles", UnitFamilyName.Distance, 1.15078), // 1 nmi = 1.151 mi

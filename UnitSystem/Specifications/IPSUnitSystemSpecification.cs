...
namespace FoundryRulesAndUnits.Units.Specifications
{
    ...
    public class IPSUnitSystemSpecification : UnitSystemSpecificationBase
    {
        ...
        UnitDefinition.BaseUnit("in2", "square inches", UnitFamilyName.Area, "in²"),
        UnitDefinition.LinearUnit("ft2", "square feet", UnitFamilyName.Area, 144.0, "ft²"),        // ASCII: ft2, Unicode: ft²
        UnitDefinition.LinearUnit("yd2", "square yards", UnitFamilyName.Area, 1296.0, "yd²"),      // ASCII: yd2, Unicode: yd²
        UnitDefinition.LinearUnit("acre", "acres", UnitFamilyName.Area, 6272640.0),         // 1 acre = 6,272,640 in²
        UnitDefinition.LinearUnit("m2", "square meters", UnitFamilyName.Area, 1550.0031, "m²"),   // ASCII: m2, Unicode: m²
            // Volume units (cubic inches as base) - using enhanced approach with UnitFamilyName enum!
        UnitDefinition.BaseUnit("in3", "cubic inches", UnitFamilyName.Volume, "in³"),
        UnitDefinition.LinearUnit("ft3", "cubic feet", UnitFamilyName.Volume, 1728.0, "ft³"),      // ASCII: ft3, Unicode: ft³
        UnitDefinition.LinearUnit("yd3", "cubic yards", UnitFamilyName.Volume, 46656.0, "yd³"),    // ASCII: yd3, Unicode: yd³
            ...
            // Acceleration units (inches per second squared as base) - ASCII canonical with Unicode display
            UnitDefinition.BaseUnit("in/s2", "inches per second squared", UnitFamilyName.Acceleration, "in/s²"),
            UnitDefinition.LinearUnit("ft/s2", "feet per second squared", UnitFamilyName.Acceleration, 12.0, "ft/s²"),       // 1 ft/s² = 12 in/s²
            UnitDefinition.LinearUnit("m/s2", "meters per second squared", UnitFamilyName.Acceleration, 1.0/0.0254, "m/s²"), // 1 m/s² = 39.3701 in/s²
            UnitDefinition.LinearUnit("mm/s2", "millimeters per second squared", UnitFamilyName.Acceleration, 0.001/0.0254, "mm/s²"), // 1 mm/s² = 0.0393701 in/s²
            UnitDefinition.LinearUnit("gee", "standard gravity", UnitFamilyName.Acceleration, 9.80665/0.0254),               // 1 gee = 386.089 in/s² ("g" collides with grams)

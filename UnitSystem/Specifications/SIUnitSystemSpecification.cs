...
namespace FoundryRulesAndUnits.Units.Specifications
{
    ...
    /// </summary>
    public class SIUnitSystemSpecification : IUnitSystemSpecification
    {
        public string SystemName => "SI";

        public string SystemDescription => "SI (International System of Units) with all seven base units: meters, kilograms, seconds, Kelvin, amperes, moles, candela";
